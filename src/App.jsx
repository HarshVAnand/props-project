  ...
  return (
    <div className="parent">
      {jobOpenings.map(function (elems, idx) {
        ...
        return <div key={idx}>
        <Cards brandLogo={elems.brandLogo} companyName={elems.companyName} datePosted={elems.datePosted} post={elems.post} tag1={elems.tag1} tag2={elems.tag2} pay={elems.pay} location={elems.location} />
         </div>
      })}
    </div>
  )
